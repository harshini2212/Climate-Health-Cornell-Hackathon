...
import { ACTION_LABEL, TIER_BADGE, TIER_LABEL, fmtDate, fmtInt, handleFor } from "../lib/labels";
...
export function Forecast({ scenario, onSource, onOpen }: { scenario: string; onSource: (s: Source) => void; onOpen: (s: ScreenKey) => void }) {
  ...
  useEffect(() => {
    getForecast(scenario, scenarioMeta(scenario).day)
      .then((f) => {
        setForecast(f);
        onSource(lastSource());
    ...
    <div className="page dash">
      <div className="strip">
        ...
        <div className="stat hero">
          ...
          <div className="s">vs. oldest-first, same {callsCap} calls</div>
        </div>
        <div className="stat">
